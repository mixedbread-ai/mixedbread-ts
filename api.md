...
- <code><a href="./src/resources/stores/stores.ts">StoreGrepResponse</a></code>
- <code><a href="./src/resources/stores/stores.ts">StoreListChunksResponse</a></code>
...
- <code title="post /v1/stores">client.stores.<a href="./src/resources/stores/stores.ts">create</a>({ ...params }) -> Store</code>
- <code title="get /v1/stores/{store_identifier}">client.stores.<a href="./src/resources/stores/stores.ts">retrieve</a>(storeIdentifier) -> Store</code>
...
- <code title="delete /v1/files/{file_id}">client.files.<a href="./src/resources/files/files.ts">delete</a>(fileID) -> FileDeleteResponse</code>
...
- <code><a href="./src/resources/files/uploads.ts">UploadAbortResponse</a></code>
