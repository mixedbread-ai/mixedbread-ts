...
- <code><a href="./src/resources/base.ts">BaseStatusResponse</a></code>

Methods:

- <code title="get /">client.base.<a href="./src/resources/base.ts">status</a>() -> BaseStatusResponse</code>
...
- <code><a href="./src/resources/document-ai/parse.ts">ParseCreateResponse</a></code>
- <code><a href="./src/resources/document-ai/parse.ts">ParseRetrieveResponse</a></code>

Methods:

- <code title="post /v1/document-ai/parse">client.documentAI.parse.<a href="./src/resources/document-ai/parse.ts">create</a>({ ...params }) -> ParseCreateResponse</code>
- <code title="get /v1/document-ai/parse/{job_id}">client.documentAI.parse.<a href="./src/resources/document-ai/parse.ts">retrieve</a>(jobId) -> ParseRetrieveResponse</code>
...
- <code title="put /v1/files/{file_id}">client.files.<a href="./src/resources/files.ts">update</a>(fileId, { ...params }) -> FileUpdateResponse</code>
...
- <code title="get /v1/jobs/{job_id}">client.jobs.<a href="./src/resources/jobs.ts">retrieve</a>(jobId) -> JobRetrieveResponse</code>
