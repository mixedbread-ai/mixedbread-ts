...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/vector_stores/{vector_store_id}/files',
...
export const handler = (client: Mixedbread, args: Record<string, unknown> | undefined) => {
  const { vector_store_id, ...body } = args as any;
